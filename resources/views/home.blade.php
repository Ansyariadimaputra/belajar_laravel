...
<head>
    ...
    <link href="{{ asset('css/nav-styles.css') }}" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <div class="container px-4">
            <a class="navbar-brand" href="#page-top">Belajar Laravel</a>
    ...
    <header class="bg-primary bg-gradient text-white">
        <div class="container px-4 text-center">
            <h1 class="fw-bolder">Selamat Datang Di Belajar ini</h1>
            <p class="lead">
                HOME
            </p>
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('js/nav-scripts.js') }}"></script>
</body>
